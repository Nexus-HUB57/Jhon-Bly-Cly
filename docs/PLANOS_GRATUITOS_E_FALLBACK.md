...
| MiniMax | O painel oficial da conta verificou saldo efetivo de US$ 0,00; a documentação associa o erro 1008 a saldo insuficiente e direciona a Billing/Balance. [6] | A geração H3 é assíncrona e depende do saldo/recursos da conta. | **Indisponível para nova tentativa KTD** enquanto o proprietário não recarregar a conta. |
