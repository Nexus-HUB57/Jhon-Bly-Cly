...
export default function EcosystemFusion() {
  ...
  return <div className="mx-auto max-w-[1500px] space-y-6 pb-10">
    ...
    <section className="grid gap-5 xl:grid-cols-[0.74fr_1.26fr]">
      <div className="glass-panel p-6"><span className="eyebrow">POLÍTICA DE FUSÃO</span><h2 className="mt-2 text-xl font-black tracking-tight">Três camadas para manter controle.</h2><div className="mt-6 space-y-4"><Policy icon={ShieldCheck} title="Adaptar com revisão" copy="Padrões de harness e MCP com licenças claras podem orientar conectores e contratos, sem execução dinâmica." tone="cyan" /><Policy icon={Layers3} title="Catalogar, não embutir" copy="Modelos, listas de recursos e prompts sem licença assertiva ficam disponíveis como metadados de decisão." tone="blue" /><Policy icon={ShieldOff} title="Bloquear conteúdo sensível" copy="Fontes de prompts internos, vazamentos ou rotas que contornem provedores são explicitamente excluídas do runtime." tone="coral" /></div><div className="mt-6 rounded-2xl border border-slate-200 bg-slate-950 p-4"><p className="font-mono text-xs leading-6 text-cyan-100">event: ecosystem.fusion.catalog.synchronized<br />schema: 1.0<br />delivery: pronto para orquestração</p></div></div>
